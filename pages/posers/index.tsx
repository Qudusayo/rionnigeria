      ...
      <Component>
        <div className={styles.PosersSector}>
          ...
          <p className={styles.PosersSectorInfo}>
            ...
            down Islam with unimaginable lies and negative comments, yet there
            are numerous questions and knots in their faith calling for
            solutions before they can settle on criticising Islam.
            <br /> Some of such knots are posed hereunder for them to tackle and
            for any doubting Muslim to mind before considering Christianity.
            Some of these posers can also be found in our books and a lot is
            still there!
            <br />
            <u>
              We strongly welcome contributions from Muslims brothers and
              sisters
            </u>
          </p>
          <div className={styles.PosersSectorContent}>
            ...
            >
              <div className={styles.FlexLeftNoImgCardMain}>
                <Card
                  imageUrl={
                    "https:" + posers[0].fields.thumbnail.fields.file.url
                  }
