        ...
        <div className={styles.AnalysisSectorContent}>
          <div className={styles.GridFiveLayer}>
            <div className={styles.GridFiveLayerMain}>
              <Card
                imageUrl={"https:" + analysis[0].fields.thumbnail.fields.file.url}
                contentURL={"/analysis/" + analysis[0].fields.slug}
                title={analysis[0].fields.title}
                date={moment(analysis[0].fields.publishedDate).format("MMM DD, YYYY, HH:mm")}
                ...
                ?.map((analys) => {
                  return (
                    <Card
                      ...
                      date={moment(analys.fields.publishedDate).format("MMM DD, YYYY, HH:mm")}
                    />
                  );
                })}
            </div>
