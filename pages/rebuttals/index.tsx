    ...
    <PageSeo title="Rebuttals">
      <Component>
        ...
        <div className={styles.RebutalsSectorContent}>
          <div className={[styles.FlexImageColumn, styles.FlexImageColumnRev].join(" ")}>
            <div className={styles.FlexImageColumnMain}>
              <Card
                imageUrl={"https:" + rebuttals[0].fields.thumbnail.fields.file.url}
                contentURL={"/rebuttals/" + rebuttals[0].fields.slug}
                title={rebuttals[0].fields.title}
                date={moment(rebuttals[0].fields.publishedDate).format("MMM DD, YYYY, HH:mm")}
                type="flex-right"
                summary={
                ...
                ?.map((rebuttal) => {
                  return (
                    <Card
                      ...
                      date={moment(rebuttal.fields.publishedDate).format("MMM DD, YYYY, HH:mm")}
